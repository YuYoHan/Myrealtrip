...
insert into admin(admin_email, admin_name, admin_role) values ('zxzz45@naver.com', '유요한', 'ADMIN');
...
values ('뉴욕', '뉴욕', 'https://d2ur7st6jjikze.cloudfront.net/landscapes/4721_large_square_1535704006.jpg?1535704006');
insert into travelCard (title, contents, travel_image)
...
insert into travelCard (title, contents, travel_image)
values ('루체른', '루체른', 'https://d2ur7st6jjikze.cloudfront.net/landscapes/476_large_square_1448513381.jpg?1448513381');
insert into travelCard (title, contents, travel_image)
...
insert into mainBanner (bannerURL, bannerImage) values('https://www.myrealtrip.com/promotions/lucky_week3_main','https://d2ur7st6jjikze.cloudfront.net/cms/1560_original_1654246467.png?1654246467');
insert into mainBanner (bannerURL, bannerImage) values('https://www.myrealtrip.com/promotions/mrtcommunity','https://d2ur7st6jjikze.cloudfront.net/cms/2125_original_1652664555.png?1652664555');
insert into mainBanner (bannerURL, bannerImage) values('https://www.myrealtrip.com/themes/1041/offers','https://d2ur7st6jjikze.cloudfront.net/cms/1252_original_1653271301.png?1653271301');
insert into mainBanner (bannerURL, bannerImage) values('https://market.bomappbiz.co.kr/overseas-axa?partner=MYREALTRIP','https://d2ur7st6jjikze.cloudfront.net/cms/1643_original_1652173495.png?1652173495');
insert into mainBanner (bannerURL, bannerImage) values('https://www.myrealtrip.com/promotions/donkey','https://d2ur7st6jjikze.cloudfront.net/cms/1527_original_1650959341.png?1650959341');
insert into mainBanner (bannerURL, bannerImage) values('https://www.myrealtrip.com/promotions/jejuplus_202204','https://d2ur7st6jjikze.cloudfront.net/cms/1648_original_1653994068.png?1653994068');
...
(
    ...
    hotel_id      bigint references hotels (hotel_id), #호텔번호
    price         varchar(3000) not null,              #가격
