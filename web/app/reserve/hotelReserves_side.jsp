    ...
    <div class="SectionContainer-container">
                        ...
                        <div class="AllTerms-termContainer">
                            <div class="AllTerms-termContainer">
                                <div class="required-term">
                                    <input type="checkbox" aria-hidden="true" class="term-defaultCheckTerm">여행자 약관 동의
                                    (필수)</input>
                                    <img class="css-xqn21t"
                                         src="https://dffoxz5he03rp.cloudfront.net/icons/ic_arrowright_md_gray_300.svg">
                                </div>
                                <div class="required-term">
                                    <input type="checkbox" aria-hidden="true" class="term-defaultCheckTerm">개인정보 제공
                                    동의(필수)</input>
                                    <img class="css-xqn21t"
                                         src="https://dffoxz5he03rp.cloudfront.net/icons/ic_arrowright_md_gray_300.svg">
                                </div>
                                <div class="required-term">
                                    <input type="checkbox" aria-hidden="true" class="term-defaultCheckTerm">개인정보 수집 및 이용
                                    동의(필수)</input>
                                    <img class="css-xqn21t"
                                         src="https://dffoxz5he03rp.cloudfront.net/icons/ic_arrowright_md_gray_300.svg">
                                </div>
        ...
        <div class="PurchaseButton-buttonWrapper">
		    <span role="button" class="css-w0pi5v">
			    <a style="width: 100%;"
                   href="${cp}/pay/payment.pm?dateFilter=${param.dateFilter}&hotelNum=${param.hotelNum}&hotelName=${param.hotelName}&hotelImg=${param.hotelImg}&hotelPrice=${param.hotelPrice}&userEmail=${loginUser.userEmail}">
